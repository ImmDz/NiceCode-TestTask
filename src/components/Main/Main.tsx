...
export const Main = ({ choosenPatient }: IMain) => {
    ...
    return (
        <div className={style.mainContainer}>
            {choosenPatient && <div className={style.mainHeader}>
                <div className={style.photo}>
                    <img src={choosenPatient?.img} alt="photo" />
                </div>
                <div className={style.info}>
                    <p>{choosenPatient?.name} {choosenPatient?.surname}</p>
                    {choosenPatient && <p>{choosenPatient?.age} лет, {choosenPatient?.gender}</p>}
                </div>
            </div>}
            <div className={style.mainInteraction}>
                ...
                {activeTab === "Заметки" &&
                    <button
                        ...
                        className={style.add}>Новая заметка <Plus />
                    </button>}
            </div>
